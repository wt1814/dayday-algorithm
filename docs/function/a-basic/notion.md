...
### 1.1.2. 常用结构  
&emsp; 在Java编程语言中，最基本的结构就是两种，一种是数组，一种是模拟指针（引用/链表），所有的数据结构都可以用这两个基本结构构造。<font color = "clime">数组与链表属于物理结构；</font><font color = "red">栈、队列、树等属于逻辑结构，实现方式有数组和链表两种方式。</font>  
...
![image](https://gitee.com/wt1814/pic-host/raw/master/algorithm/function-25.png)  
